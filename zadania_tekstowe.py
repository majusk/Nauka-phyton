...
print ("ale potem zjada 25kg paszy. Ile wynosi jej npwa waga?")
...
print ("6 towarzyszy 3 butelki piwa. Ile butelek piwa zostało zakupionych?")
input ("Aby się dowiedzieć, naciśnij klawisz Enter.")
print ("6*3=", 6*3)
...
input ("Aby się dowiedzieć, nacisnij klawisz Enter.")
print ("159 / 4 =", 159 / 4)

print ("\n Grupa 4 piratów znajduję skrzynię, a w niej 107 złotych monet, i")
...
print("monet ze znalezionej skrzyni. Ile monet zostanie w podziale?")
input ("Aby się dowiedzieć naciśnij klawisz Enter")
print ("107 % 4=", 107 %4)
